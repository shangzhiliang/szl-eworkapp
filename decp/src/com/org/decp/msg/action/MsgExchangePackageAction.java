...
public class MsgExchangePackageAction extends BaseStruts2Action
{
  private static final long serialVersionUID = 1L;
  private static final Logger LOGGER = LoggerFactory.getLogger(MsgExchangePackageAction.class);
  protected MsgExchangePackage entity;
  protected MsgExchangePackageQuery queryEntity;
  protected MsgExchangePackageService entityService;
  private KeyGeneratorContainer keyGeneratorContainer;

  public void init()
  {
    this.entity = new MsgExchangePackage();
    this.queryEntity = new MsgExchangePackageQuery();
  }
    ...
    throws Exception
  {
    if ("toEdit".equals(this.operate))
    {
      ...
      this.entity = ((MsgExchangePackage)this.entityService.selectByPK(this.entity));
    ...
    throws Exception
  {
    ...
    if (StringUtils.isNotEmpty(selectedIds)) {
      ...
      for (int i = 0; i < idArray.length; i++) {
        MsgExchangePackagePK pk = new MsgExchangePackagePK();
        pk.setId(idArray[i]);
  ...
  public MsgExchangePackage getEntity()
  {
    return this.entity;
  }

  public void setEntity(MsgExchangePackage entity) {
    this.entity = entity;
  }

  public MsgExchangePackageQuery getQueryEntity() {
    return this.queryEntity;
  }

  public void setQueryEntity(MsgExchangePackageQuery queryEntity) {
    this.queryEntity = queryEntity;
  }

  public void setEntityService(MsgExchangePackageService entityService) {
